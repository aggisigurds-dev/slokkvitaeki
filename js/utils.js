...
var Print={job:null,showJob:function(job){this.job=job;var html='<div style="font-size:12px;font-weight:700;color:#888;text-transform:uppercase;letter-spacing:.05em;margin-bottom:10px">Miðar ('+job.units.length+' stk.)</div>';job.units.forEach(function(u){html+='<div class="stk-prev"><div class="stk-logo"><div class="stk-logo-dot"><svg viewBox="0 0 24 24"><path d="M12 2C9.5 5 8 7.5 8 10a4 4 0 008 0c0-1.5-.5-3-2-4.5-.5 2-1.5 3-2 3.5-.5-.5-1-2-.5-4.5C11 5 10 6.5 10 6.5S12 5 12 2zm-2 14h4v6h-4v-6z"/></svg></div><div class="stk-logo-txt">Slökkvitæki ehf<br>Brunakerfi</div></div>';html+='<div class="stk-body"><div class="stk-fields">';html+='<div class="stk-f"><div class="stk-f-lbl">Verk</div><div class="stk-f-val">'+U.e(job.num)+'</div></div>';html+='<div class="stk-f"><div class="stk-f-lbl">Viðskiptavinur</div><div class="stk-f-val">'+U.e(job.customer)+'</div></div>';html+='<div class="stk-f"><div class="stk-f-lbl">Þjónusta</div><div class="stk-f-val">'+U.e(u.service)+'</div></div>';html+='<div class="stk-f"><div class="stk-f-lbl">Móttekið</div><div class="stk-f-val">'+U.fd(job.dropoff)+'</div></div>';html+='</div><div class="stk-qr">'+QR.svg(u.serial,52)+'</div></div></div>';});html+='<hr style="border:none;border-top:1px solid #ddd;margin:14px 0"/>';html+='<div class="rcpt-co">Slökkvitæki ehf · Brunakerfi</div>';html+='<div class="rcpt-ln"><span>Verk númer</span><span style="font-weight:700">'+U.e(job.num)+'</span></div>';html+='<div class="rcpt-ln"><span>Viðskiptavinur</span><span>'+U.e(job.customer)+'</span></div>';html+='<div class="rcpt-ln"><span>Sími</span><span>'+U.e(job.phone)+'</span></div>';job.units.forEach(function(u){html+='<div class="rcpt-ln"><span>'+U.e(u.serial)+'</span><span>'+U.e(u.service)+'</span></div>';});html+='<div class="rcpt-ln rcpt-tot"><span>Móttökudagur</span><span>'+U.fd(job.dropoff)+'</span></div>';html+='<div class="rcpt-note">Við hringum þegar tilbúið · +354 XXX XXXX</div>';document.getElementById('print-body').innerHTML=html;Modal.open('modal-print');},
