...
(() => {
  ...
  function injectStyles() {
    ...
    const css = [
      ...
      P + '.bk-sub{color:var(--ink2,#475569);font-size:13px;margin:2px 0 16px;max-width:720px;line-height:1.5}',
      ...
      P + '.bk-tab{padding:9px 13px;border:none;background:none;border-bottom:2px solid transparent;color:var(--ink2,#475569);font-weight:700;font-size:13.5px;cursor:pointer;margin-bottom:-1px}',
      ...
      P + '.bk-stat .l{font-size:12px;color:var(--ink2,#475569);margin-top:3px}',
