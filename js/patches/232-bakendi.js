...
(() => {
  ...
  function injectStyles() {
    ...
    const css = [
      ...
      P + '.bk-sub{color:var(--ink1,#0f172a);font-size:13px;margin:2px 0 16px;max-width:720px;line-height:1.5}',
      ...
      P + '.bk-tab{padding:9px 13px;border:none;background:none;border-bottom:2px solid transparent;color:var(--ink1,#0f172a);font-weight:700;font-size:13.5px;cursor:pointer;margin-bottom:-1px}',
      ...
      P + '.bk-stat .l{font-size:12px;color:var(--ink1,#0f172a);margin-top:3px}',
      ...
      P + 'th{background:var(--surface2,#f8fafc);color:var(--ink1,#0f172a);font-size:10.5px;font-weight:700;text-transform:uppercase;letter-spacing:.04em;text-align:left;padding:9px 13px;border-bottom:1px solid var(--brd,#e6eaf0);white-space:nowrap}',
