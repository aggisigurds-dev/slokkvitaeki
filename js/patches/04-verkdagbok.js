...
(() => {
  ...
  // á meðan DB.sb var null. Nú er varabiðlarinn búinn til einu sinni og
  // endurnýttur; DB.sb ræður áfram um leið og hann er til.
  let _fb = null;
  ...
  function ensureNavButton() {
    ...
    // 2026-06-12 (Todoist): tók út amber-tintinn svo flipinn líti eins út og hinir.
    btn.style.cssText = 'position:relative;z-index:5';
