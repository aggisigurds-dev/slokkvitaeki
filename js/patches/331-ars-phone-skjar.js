  ...
  function css() {
    ...
    return [
      ...
      W + '#view-arsskodun ._ars-tblscroll' + P + ','
        ...
        /* 23.09.2026 — ZOOM OG PoNNUN: MAELT, EKKI LAGAd.
           Agnar: „when i zoom i can slide all the way to right or left".
           Maelt i framleidslu (Skjar-hamur, 375px):
             zoom 100%  tafla 1456  kassi 1682  -> 226px audir
             zoom  65%  tafla  947  kassi 1682  -> 735px audir
             zoom  52%  tafla  758  kassi 1682  -> 924px audir
           Kassinn fylgir ALDREI zoom-inu. Eg profadi `width:max-content` her og thad
           dugar ekki af tveimur astaedum, badar staafestar i vafra:
             1. patch 341 setur `width:100%!important` a somu stok med TVOFOLDU
                audkenni (#arsskodun-wrap#arsskodun-wrap) og vinnur cascade-inn.
             2. thott thad ynni: `max-content` a #ars-main maelir INNRI staerd
                toflunnar, og innri staerd tekur ekki mid af `zoom`. #ars-main maeldist
                1748px a ollum zoom-stigum.
           Retta leidin er thvi EKKI CSS heldur ad setja beina breidd a kassann
           (taflubreidd x zoom) i sama falli og setur --ars-skjar-zoom. Ogert. */
