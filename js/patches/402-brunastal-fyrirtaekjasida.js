...
(function () {
  ...
  var css = [
    ...
    /* ── skeljar ── */
    r('._samskipti-card,.ut-list,._afsl-box,._dyg-section.sk-card:not(.b403),._ufs-section.sk-card,._co-mail-box', SHELL + ';padding:0'),
    ...
    r('._samskipti-card,._afsl-box,.ut-list,._dyg-section.sk-card:not(.b403),._ufs-section.sk-card', 'background:' + PLATE + ';background-image:' + PLATE_IMG),
