...
(() => {
  ...
  async function openSaleDetail(id) {
    ...
    html += '<table style="width:100%;border-collapse:collapse;font-size:13px;border:1px solid #e2e8f0;border-radius:8px;overflow:hidden"><thead><tr style="background:#f8fafc;color:#64748b;font-size:11px;text-transform:uppercase"><th style="text-align:left;padding:6px">Vara</th><th style="text-align:right;padding:6px">Magn</th><th style="text-align:right;padding:6px">Verð</th><th style="text-align:right;padding:6px">Samtals án vsk</th></tr></thead><tbody>' + lrows + '</tbody></table>';
