...
- **2026-09-23 (stöðugt viðmót — VÖRÐUÐU skrárnar 153 og 187)** — AÐEINS teiknun, engin breyting á rökum: hvaða ár er grænt, hvað telst skoðað, talningar og skrif eru ÓSNERTIN. (1) : hleðslararnir fimm rifu ÖLL árs-reitina út (mælt 201 hnútar) og byggðu þá aftur, sjö sinnum per opnun — taflan mjókkaði á meðan svo dálkar hoppuðu. Nú ein samandregin endurbygging (60 ms) og reitirnir uppfærðir Á STAÐNUM ( aðeins þegar innihald breytist); enginn hnútur fjarlægður. (2)  : skrunstaða (líka lárétt skrun töflunnar) og fókus í HVAÐA reit sem er endurheimt í sama tifi og teikningin — áður var aðeins leitarreiturinn varinn. (3) : bakgrunns-teikning bíður meðan notandi skrifar í reit og keyrir strax við focusout. (4)  : samtíma kallarar (190 · 304 · show) deila EINNI hleðslu. Sönnun: fingrafar allra árs-reita (klasar + texti) tekið á lifandi fyrir og eftir.
