...
Slökkvitæki ehf · 7. september 2026 · unnið úr Allir viðskiptavinir (157) + skjalagrunni. Gagnvirka útgáfan: [an-samnings-uttekt-2026-09-07.html](an-samnings-uttekt-2026-09-07.html). Greiningin sjálf breytti engu; kl. 12:30 voru 36 fyrirtæki sett í þjónustu að ósk Agnars (sjá Staða). 🔥-takkinn á síðunni tekur úr þjónustu aftur.

## Staða 07.09.2026 kl. 12:30 — 36 sett aftur í þjónustu

Að ósk Agnars („mátt kannski bara setja fyrirtækin aftur í þjónustu, ég hendi þeim aftur út þegar ég er búinn að skoða þau betur") voru **36 fyrirtæki** sett í þjónustu (`er_i_thjonustu = true` + `subscribed` í stillingum + færsla í `override_log`). Afrit fyrir: `backup_20260907_er_i_thjonustu`. **Sleppt (5):** Gára ehf. (aukaþjónusta með skipakúta, óregluleg búðarsala), GK-bílar ehf. (rútufyrirtæki, koma með slatta á sumrin), Partýbær ehf. (annar greiðandi sem á heima í þjónustu), Staðgreitt (staðgreiðslukúnninn) og ICS ehf. (bank-greiðandi). Þau eru merkt ⏸ í töflunni.
