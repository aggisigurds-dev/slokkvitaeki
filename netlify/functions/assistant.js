...
function systemPrompt(minni) {
  ...
  return (
    ...
    + 'Icelandic fully. REPLY IN ICELANDIC in writing \u2014 the English-only rule is for the '
    + 'spoken Jarvis voice (talsvör), NOT this written assistant. Keep Icelandic proper nouns, company '
